...
public static void clickonday2_upsx() throws Exception {
	System.out.println("Clicking  on day2");
	logStep("Clicking  on day2");
	Thread.sleep(6000);
	
	//Ad.findElementByXPath("//android.widget.LinearLayout/android.view.ViewGroup/android.widget.TextView[1])").click();
WebElement ad=	Ad.findElementById("com.weather.Weather:id/daily_forecast_adapter_date");
ad.getAttribute("text");
	
	//List<MobileElement> all=Ad.findElementsById("com.weather.Weather:id/daily_forecast_adapter_date");
	//System.out.println(all.get(0).getText());
	
	try {
		List<WebElement> day2=Ad.findElementsById("com.weather.Weather:id/daily_forecast_adapter_date");
		day2.get(1).click();
		Thread.sleep(10000);
	}
	catch(Exception e) {
		try {
			List<WebElement> day2=Ad.findElementsById("com.weather.Weather:id/daily_forecast_adapter_skycode_icon");
			day2.get(1).click();
			Thread.sleep(10000);
		}
		catch(Exception e1) {
...
public static void clickonday3_upsx() throws Exception {
	System.out.println("Clicking  on day3");
	logStep("Clicking  on day3");
	Thread.sleep(6000);
	try {
		List<WebElement> day3=Ad.findElementsById("com.weather.Weather:id/daily_forecast_adapter_high_temperature");
		day3.get(2).click();
		Thread.sleep(10000);
	}
	catch(Exception e) {
...
public static void clickonday4_upsx() throws Exception {
	System.out.println("Clicking  on day4");
	logStep("Clicking  on day4");
	Thread.sleep(6000);
	try {
		List<WebElement> day4=Ad.findElementsById("com.weather.Weather:id/daily_forecast_adapter_high_temperature");
		day4.get(3).click();
		Thread.sleep(10000);
	}
	catch(Exception e) {
...
public static void clickonday5_upsx() throws Exception {
	System.out.println("Clicking  on day5");
	logStep("Clicking  on day5");
	Thread.sleep(6000);
	try {
		List<WebElement> day5=Ad.findElementsById("com.weather.Weather:id/daily_forecast_adapter_high_temperature");
		day5.get(4).click();
		Thread.sleep(10000);
	}
	catch(Exception e) {
...
public static void clickonday2_old() throws Exception {
	System.out.println("Clicking  on day2");
	logStep("Clicking  on day2");
	Thread.sleep(6000);
	try {
...
Thread.sleep(10000);
		...
		List<WebElement> day2=Ad.findElementsByClassName("android.widget.TextView");
		day2.get(1).click();
		Thread.sleep(10000);
	}
	}
public static void clickonday3_old() throws Exception {
	System.out.println("Clicking  on day3");
	logStep("Clicking  on day3");
	Thread.sleep(6000);
	try {
